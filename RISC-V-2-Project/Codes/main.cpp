...
processor_obj.decode_instruction(instruction_mem[50]);
/*processor_obj.decode_instruction(instruction_mem[51]);
processor_obj.decode_instruction(instruction_mem[52]);
processor_obj.decode_instruction(instruction_mem[53]);
processor_obj.decode_instruction(instruction_mem[54]);*/
