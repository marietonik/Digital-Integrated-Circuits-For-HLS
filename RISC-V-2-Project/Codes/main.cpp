...
instruction_mem[51] = 0b01000000101001111000000010110011; // SUB  R[1],  R[15], R[10]
instruction_mem[52] = 0b00000000001101001111001110110011; // AND  R[7],  R[9],  R[3]
instruction_mem[53] = 0b00000000111100011110001110110011; // OR   R[7],  R[3],  R[15]
...
instruction_mem[56] = 0b00000000000101111011000010110011; // SLTU R[1],  R[15], R[1]
instruction_mem[57] = 0b01000000011100011101010010110011; // SRA  R[9],  R[3],  R[7]
instruction_mem[58] = 0b00000000111100001101000110110011; // SRL  R[3],  R[1],  R[15]
instruction_mem[59] = 0b00000001000000111001010100110011; // SLL  R[10], R[7],  R[16]
instruction_mem[60] = 0b00000010111100111000000010110011; // MUL  R[1],  R[15], R[7]
